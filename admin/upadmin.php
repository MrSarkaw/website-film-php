...
<body>
	...
	<form method="post">
		...
		$insert="update  admin set password='".$_POST["password"]."' , permission_level='".$_POST["level"]."' where first_name='".$_POST["firstname"]."'"; 
			$insertt=mysqli_query($con,$insert);
	if(isset($insertt)){
		echo '<div style="width:100%;height;30px;background-color:#616F39;color:white;text-align:center;position:relative;top:20px;left:0px;"><h3>update it</h3></div>';
	}
	
	}?>
	</div>
	
	<div id="divDisplayAdmin" class="col-sm-5">
	<table>
