...
<meta http-equiz="contetn.type" content="text/html" charset="utf-8">
	<style>
		...
		#div7{
			position: absolute;
			top:100px;
			left: 300px;width:70%;height: 400px;background-color: none;
...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<input type="text" name="namef" placeholder="ناوی فیلم"> 
		<input type="file" name="file" placeholder="ڕه‌سمی فیلم" id="file"> 
				<textarea name="des" > ... وته‌كه‌</textarea>
	...
	$insert=mysqli_query($con,"insert into qouteoffilms (name_films,image_film,qoute,id_user)
	values('".$_POST["namef"]."','".$image."','".$_POST["des"]."','".$row["id_user"]."')");
